...
3. Project names should use kebab-case matching directory names (e.g., walter-worker, skill-factory)
...
---
*Generated by walter-worker-session-memory using qwen3:30b*
"""
...
> Auto-generated index of all session memory cards. Updated by walter-worker-session-memory.
