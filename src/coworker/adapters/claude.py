...
def _build_static_block(catalog: ProjectCatalog) -> str:
    ...
    lines.append("")
    lines.append("2-tier layout:")
    lines.append(f"- Project level: `docs/prd/`, `docs/spec/`, `docs/plan/`, `docs/test/`")
    lines.append(f"- Initiative level: `docs/initiatives/<name>/<name>-spec.md`, `<name>-plan.md`")
    lines.append("")
