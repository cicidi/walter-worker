...
### 15. feat: add session-memory skill to ai-coworker skills/
- **Source**: git-commit
...
### 24. docs: rewrite README and blueprint — ai-coworker is context manager, not dev tool
- **Source**: git-commit
...
### 32. chore: remove personal/skills/ from ai-coworker, skills live in skill-factory
- **Source**: git-commit
